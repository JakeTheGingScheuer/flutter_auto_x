...
class CarClassResultState extends State<CarClassResult> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    animation = Tween<double>(begin: 80, end: 36).animate(curvedAnimation)
      ..addListener(() {
        setState(() {});
      })
    ...
    animColor = ColorTween(begin: Color.fromRGBO(240, 200, 200, 1.0), end: Color.fromRGBO(240, 10, 10, 1.0))
